...
class Category
{
     ...
     * @return Category
     */
    public function addStarter(\Uteg\BaseBundle\Entity\Starters2Competitions $starters)
    {
     ...
     * @param \Uteg\BaseBundle\Entity\Starters2Competitions $starters
     */
    public function removeStarter(\Uteg\BaseBundle\Entity\Starters2Competitions $starters)
    {
