...
class Competition
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Module", inversedBy="comps")
     ...
     * Add users
     *
     * @param \Uteg\BaseBundle\Entity\User $users
     * @return Competition
     */
    public function addUser(\Uteg\BaseBundle\Entity\User $users)
    {
        $this->users[] = $users;
     ...
     * @param \Uteg\BaseBundle\Entity\User $users
     */
    public function removeUser(\Uteg\BaseBundle\Entity\User $users)
    {
     ...
     * Add s2cs
     *
     * @param \Uteg\BaseBundle\Entity\Starters2Competitions $starters
     * @return Competition
     */
    public function addS2c(\Uteg\BaseBundle\Entity\Starters2Competitions $starters)
    {
        $this->s2cs[] = $starters;
     ...
     * @param \Uteg\BaseBundle\Entity\Starters2Competitions $starters
     */
    public function removeS2c(\Uteg\BaseBundle\Entity\Starters2Competitions $starters)
    {
     ...
     * Add c2is
     *
     * @param \Uteg\BaseBundle\Entity\Clubs2Invites $c2is
     * @return Competition
     */
    public function addC2i(\Uteg\BaseBundle\Entity\Clubs2Invites $c2is)
    {
        $this->c2is[] = $c2is;
     ...
     * @param \Uteg\BaseBundle\Entity\Clubs2Invites $c2is
     */
    public function removeC2i(\Uteg\BaseBundle\Entity\Clubs2Invites $c2is)
    {
     ...
     * Set module
     *
     * @param \Uteg\BaseBundle\Entity\Module $module
     * @return Competition
     */
    public function setModule(\Uteg\BaseBundle\Entity\Module $module = null)
    {
        $this->module = $module;
     ...
     * Get module
     *
     * @return \Uteg\BaseBundle\Entity\Module 
     */
