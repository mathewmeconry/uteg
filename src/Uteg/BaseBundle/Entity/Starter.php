...
class Starter
{
     ...
     * Add s2c
     *
     * @param \Uteg\BaseBundle\Entity\Starters2Competitions $s2c
     * @return Starter
     */
    public function addS2c(\Uteg\BaseBundle\Entity\Starters2Competitions $s2c)
    {
        $this->s2cs[] = $s2c;
     ...
     * Remove s2c
     *
     * @param \Uteg\BaseBundle\Entity\Starters2Competitions $s2cs
     */
    public function removeS2c(\Uteg\BaseBundle\Entity\Starters2Competitions $s2c)
    {
