...
class PermissionMap extends BasicPermissionMap
{
    ...
    const PERMISSION_CLUBS_VIEW = 'CLUBS_VIEW';
    const PERMISSION_CLUBS_EDIT = 'CLUBS_EDIT';
    ...
    public function __construct()
    {
        $this->map = array(
            self::PERMISSION_VIEW => array(
                ...
                MaskBuilder::MASK_CLUBS_VIEW,
                MaskBuilder::MASK_CLUBS_EDIT,
            ...
            self::PERMISSION_CLUBS_EDIT => array(
                MaskBuilder::MASK_CLUBS_EDIT,
                MaskBuilder::MASK_MASTER,
                MaskBuilder::MASK_OWNER,
            ),

            self::PERMISSION_CLUBS_VIEW => array(
                MaskBuilder::MASK_CLUBS_VIEW,
                MaskBuilder::MASK_CLUBS_EDIT,
                MaskBuilder::MASK_MASTER,
                MaskBuilder::MASK_OWNER,
